...
class TestMakeNERFeatureDataset:
    def test_valid(self, dataset_with_ner_probs, pred_args):
        ...
        feature_dataset = predicter.make_ner_feature_dataset(dataset_with_ner_probs, print_avg_grade=True)
...
class TestClassifierForward:
    def test_valid(self, dataset_with_ner_probs, pred_args):
        predicter = Predicter(pred_args)
        feature_dataset = predicter.make_ner_feature_dataset(dataset_with_ner_probs)
